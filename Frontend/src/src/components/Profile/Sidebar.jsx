...
const Sidebar = ({data}) =>  {
  ...
  return (
    ...
    {role === "admin" && (
        ...
        <button className="bg-white w-3/6 lg:w-full mt-4 lg:mt-0 text-black font-semibold flex items-center 
        justify-center py-2 rounded hover:bg-black hover:text-white transition-all duration-300"
        onClick={() => {
